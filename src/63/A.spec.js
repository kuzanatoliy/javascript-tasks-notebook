...
describe('63A. Sinking Ship', () => {
  it.each`
    ...
    ${2} | ${[['Jue', 'rat'], ['Wyglbyphk', 'rat'], ['Gjlgu', 'child'], ['Gi', 'man'], ['Attx', 'rat'], ['Theorpkgx', 'man'], ['Ym', 'rat'], ['X', 'child'], ['B', 'captain'], ['Enualf', 'rat'], ['Kktsgyuyv', 'woman']]} | ${['Jue', 'Wyglbyphk', 'Attx', 'Ym', 'Enualf', 'Gjlgu', 'X', 'Kktsgyuyv', 'Gi', 'Theorpkgx', 'B']}
